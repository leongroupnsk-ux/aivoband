...
const FAQ = [
  ...
  { q: "С чего начать?", a: "Оставьте заявку — в течение 24 часов разберём задачу и предложим решение с оценкой." },
];
          ...
          <Reveal>
            ...
            >
              ...
              <p className="mx-auto mt-4 max-w-[46ch] text-subtle">
                Расскажите о задаче — в течение 24 часов предложим решение, сроки и оценку. Бесплатно и без обязательств.
              </p>
